...
Course: Robotic Lab Student: Leonardo Riccardi / P38000358 
...
# Core dependencies for Gazebo and ROS 2 Control
sudo apt install ros-humble-ros2-control ros-humble-ros2-controllers ros-humble-gazebo-ros2-control3. 🏗️ BUILD
...
4.2. Complete Simulation (Gazebo)
...
5.2. Launching the Trajectory Node (High-Level Control)
...
5.3. Image Visualization (Camera)

To visualize the real-time video feed from the simulated camera in Gazebo:

Launch rqt_image_view (after running source in a new terminal) and select the /camera/image topic:
